...
### 9. [Authentification](./docs/step_definitions/AUTHENTICATION_STEPS.md)
...
### 10. [Gestion de Profil](./docs/step_definitions/PROFILE_STEPS.md)
- Navigation vers la page de profil
- Changement de thème (light/dark)
- Gestion de la langue
- Format de date
- Changement de mot de passe
- Messages d'erreur et toast
- Vérification des labels et attributs
...
- **Total** : ~188 step definitions
- **Fichiers** : 10 catégories
...
- **Authentification** : Voir [AUTHENTICATION_STEPS.md](./docs/step_definitions/AUTHENTICATION_STEPS.md)
...
- **Profil utilisateur** : Voir [PROFILE_STEPS.md](./docs/step_definitions/PROFILE_STEPS.md)
...
| `je me connecte`, `magasin` | Authentification | AUTHENTICATION_STEPS.md |
...
| `thème`, `mot de passe`, `langue` | Profil | PROFILE_STEPS.md |
